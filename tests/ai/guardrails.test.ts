...
function deps(): ToolDeps {
  ...
  return {
    ...
    salesByDim: ok([]), salesObjective: ok(150_000), annualObjective: ok(1_800_000),
    productCatalog: ok([]), adsProductsToPush: ok([]), marketingActivity: ok({ campaigns: [], contents: [], collaborations: [], activations: [], brandObjectives: null }),
    clientIntel: ok([]),
